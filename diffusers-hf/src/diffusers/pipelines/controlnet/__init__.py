...
try:
    ...
    _import_structure["pipeline_controlnet_sd_xl_baseline"] = ["StableDiffusionXLControlNetPipelineBaseline"]
    _import_structure["pipeline_controlnet_sd_xl_katz"] = ["StableDiffusionXLControlNetPipelineKatz"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_controlnet_sd_xl_baseline import StableDiffusionXLControlNetPipelineBaseline
        from .pipeline_controlnet_sd_xl_katz import StableDiffusionXLControlNetPipelineKatz
